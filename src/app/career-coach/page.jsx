  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section className="w-full py-12 md:py-24 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl font-bold mb-4">Career Growth Tools</h2>
            <p className="text-muted-foreground">
              Powerful tools to help you advance in your cybersecurity career
            </p>
          </div>
            ...
            <Card className="border-2 hover:border-primary transition-colors duration-300">
              <CardContent className="pt-6 text-center flex flex-col items-center justify-between h-full">
                <div className="mb-4">
                  ...
                  <p className="text-muted-foreground">
                    Create a professional resume tailored for cybersecurity roles with our AI-powered builder.
                  </p>
                </div>
                <Link href="/ai-dashboard/resume">
            ...
            <Card className="border-2 hover:border-primary transition-colors duration-300">
              <CardContent className="pt-6 text-center flex flex-col items-center justify-between h-full">
                <div className="mb-4">
                  ...
                  <p className="text-muted-foreground">
                    Generate compelling cover letters that highlight your cybersecurity skills and experience.
                  </p>
                </div>
                <Link href="/ai-dashboard/ai-cover-letter">
                  <Button className="mt-4">
            ...
            <Card className="border-2 hover:border-primary transition-colors duration-300">
              <CardContent className="pt-6 text-center flex flex-col items-center justify-between h-full">
                <div className="mb-4">
                  ...
                  <p className="text-muted-foreground">
                    Practice with realistic cybersecurity interview questions and get AI-powered feedback.
                  </p>
                </div>
                <Link href="/ai-dashboard/interview">
                  <Button className="mt-4">
                    Prepare for Interviews <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
                </Link>
              </CardContent>
            </Card>
      ...
      <section className="w-full">
        <div className="mx-auto py-24 gradient rounded-lg">
          <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto">
            ...
            <Link href="/ai-dashboard/ai-dashboard" passHref>
              <Button
                size="lg"
                variant="secondary"
